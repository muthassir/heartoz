    ...
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-pink-50 to-orange-50 flex items-center justify-center p-4">
      ...
      <div className="bg-white rounded-3xl shadow-xl border border-rose-100 p-8 w-full max-w-sm text-center">
        ...
        <button
          onClick={handleLogin}
          disabled={loading}
          className="w-full py-3.5 rounded-2xl border-2 border-gray-200 hover:border-gray-300 bg-white hover:bg-gray-50 text-gray-700 font-semibold text-sm flex items-center justify-center gap-3 transition-all shadow-sm disabled:opacity-60">
          {loading ? (
