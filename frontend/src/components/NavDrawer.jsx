...
// import { FaSignOutAlt, FaHome, FaHeartbeat, FaList, FaCameraRetro, FaGamepad, FaLightbulb, FaCog } from "react-icons/fa";
...
// export default function NavDrawer({ open, onClose, tab, setTab, theme }) {
//   const { logout } = useAuth();
//   const primary   = theme?.primary   || "#f43f5e";
//   const secondary = theme?.secondary || "#ec4899";
//   const tertiary  = theme?.tertiary  || "#f97316";

//   const THEMED_TAB_COLORS = {
//     ...TAB_COLORS,
//     dashboard: { grad:`linear-gradient(135deg,${primary},${secondary})`, light:`${primary}11`, dot:primary },
//     dates:     { grad:`linear-gradient(135deg,${primary},${tertiary})`,  light:`${primary}11`, dot:primary },
//     settings:  { grad:"linear-gradient(135deg,#6b7280,#9ca3af)", light:"#f9fafb", dot:"#6b7280" },
//   };
...
//               background:`linear-gradient(150deg,${primary} 0%,${secondary} 55%,${tertiary} 100%)`,
...
//                 const colors = THEMED_TAB_COLORS[t.id] || THEMED_TAB_COLORS.dashboard;
//                 return (
//                   <button
//                     key={t.id}
//                     className="nav-item"
...
// client/src/components/NavDrawer.jsx
import { TABS } from "../lib/constants";
import { FaSignOutAlt, FaHome, FaHeartbeat, FaList, FaCameraRetro, FaGamepad, FaLightbulb, FaCog, FaComments, FaDice } from "react-icons/fa";
import { useAuth } from "../hooks/useAuth";
...
const TAB_DESCRIPTIONS = {
  ...
  bucket:      "Dreams to achieve together",
  memories:    "Your shared timeline",
  games:       "All games in one place",
  truthordare: "Answer honestly or dare",
  betgame:     "Tic-Tac-Toe with real stakes",
  ideas:       "Browse date inspiration",
  settings:    "Theme & app preferences",
};
...
const TAB_COLORS = {
  ...
  memories:    { grad:"linear-gradient(135deg,#f97316,#fb923c)", light:"#fff7ed", dot:"#f97316" },
  games:       { grad:"linear-gradient(135deg,#10b981,#34d399)", light:"#f0fdf4", dot:"#10b981" },
  betgame:     { grad:"linear-gradient(135deg,#10b981,#34d399)", light:"#f0fdf4", dot:"#10b981" },
  ideas:       { grad:"linear-gradient(135deg,#ec4899,#f472b6)", light:"#fdf4ff", dot:"#ec4899" },
};
...
export default function NavDrawer({ open, onClose, tab, setTab, theme }) {
  ...
  const THEMED_TAB_COLORS = {
    ...
    dashboard:   { grad:`linear-gradient(135deg,${primary},${secondary})`, light:`${primary}11`, dot:primary },
    dates:       { grad:`linear-gradient(135deg,${primary},${tertiary})`,  light:`${primary}11`, dot:primary },
    truthordare: { grad:`linear-gradient(135deg,${primary},${secondary})`, light:`${primary}11`, dot:primary },
    settings:    { grad:"linear-gradient(135deg,#6b7280,#9ca3af)", light:"#f9fafb", dot:"#6b7280" },
  };
