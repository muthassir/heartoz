...
// // bet-game tab (tic-tac-toe stakes) ────────────────────────────────
...
//   "Order my favourite takeout 🍜",
//   "Surprise me with flowers 💐",
// ];

// // theme customisation ────────────────────────────────────────────
// export const THEMES = [
//   { id:"rose",     label:"Rose",     primary:"#f43f5e", secondary:"#ec4899", tertiary:"#f97316" },
//   { id:"sunset",   label:"Sunset",   primary:"#f97316", secondary:"#fb923c", tertiary:"#f43f5e" },
//   { id:"ocean",    label:"Ocean",    primary:"#0ea5e9", secondary:"#06b6d4", tertiary:"#6366f1" },
//   { id:"grape",    label:"Grape",    primary:"#8b5cf6", secondary:"#a78bfa", tertiary:"#ec4899" },
//   { id:"midnight", label:"Midnight", primary:"#4f46e5", secondary:"#6366f1", tertiary:"#0ea5e9" },
//   { id:"mint",     label:"Mint",     primary:"#10b981", secondary:"#34d399", tertiary:"#0ea5e9" },
// ];
...
// export const TABS = [
//   {id:"dashboard",label:"Home",     emoji:"🏠", imgs: null},
//   {id:"dates",    label:"Dates",    emoji:"📅", imgs: dates},
//   {id:"bucket",   label:"Bucket",   emoji:"🌟", imgs: bucketlist},
//   {id:"memories", label:"Memories", emoji:"📸", imgs: timeline},
//   {id:"games",    label:"Games",    emoji:"🎮", imgs: game},
//   {id:"ideas",    label:"Ideas",    emoji:"💡", imgs: null},
//   {id:"settings", label:"Settings", emoji:"⚙️", imgs: null},
// ];
...
//     { id:"a1", title:"Try a new sport together",         desc:"Badminton, rock climbing, archery — first timers only." },
//     { id:"a2", title:"Midnight road trip",               desc:"No destination. Just drive until you find something interesting." },
//     { id:"a3", title:"Hiking a trail you have never done", desc:"Pack snacks, wear good shoes, get lost together." },
//     { id:"a4", title:"Go-kart racing",                   desc:"May the best driver win. Loser buys dinner." },
//     { id:"a5", title:"Kayaking or paddle boating",       desc:"Terrible at it together is the whole point." },
//     { id:"a6", title:"Escape room challenge",            desc:"60 minutes. Communicate or fail. Great therapy." },
//     { id:"a7", title:"Camping under the stars",          desc:"One tent. No wi-fi. Just the two of you." },
...
//     { id:"c1", title:"Blanket fort movie marathon",      desc:"Build it properly. Snacks mandatory. No interruptions." },
//     { id:"c2", title:"Board game championship",          desc:"Best of 5. Winner chooses next date." },
//     { id:"c3", title:"Bake something from scratch",      desc:"Pick a recipe you have never tried. Embrace the mess." },
//     { id:"c4", title:"Read the same book together",      desc:"One chapter a night. Discuss over tea." },
//     { id:"c5", title:"Spa night at home",                desc:"Face masks, foot soaks, the works." },
//     { id:"c6", title:"Puzzle night",                     desc:"1000 pieces. Music. Hours. Perfect." },
//     { id:"c7", title:"Cook a cuisine you have never tried", desc:"Pick Thai, Ethiopian, Peruvian — anything new." },
//     { id:"c8", title:"Watch every Studio Ghibli film",   desc:"In order. One a week. It is a commitment." },
//   ],
//   food: [
//     { id:"f1", title:"Street food crawl",                desc:"Pick a neighbourhood. Eat at every stall. Walk it off." },
...
// export const WYR = [
//   "Would you rather go on a spontaneous road trip OR plan a perfect weekend getaway?",
//   "Would you rather cook together every night OR always eat out at new restaurants?",
//   "Would you rather live in a cosy cottage in the mountains OR a stylish apartment in the city?",
//   "Would you rather have a movie marathon at home OR explore a new city for a day?",
//   "Would you rather receive a heartfelt handwritten letter OR an expensive surprise gift?",
//   "Would you rather spend a week with no phones OR a week with no TV?",
//   "Would you rather always travel together OR each have one solo trip per year?",
//   "Would you rather replay your first date OR go on the best date you can imagine?",
//   "Would you rather cuddle all day doing nothing OR go on an adventurous hike?",
//   "Would you rather know every thought your partner has OR keep total privacy forever?",
// ];

// export const NEVER = [
//   "Never have I ever fallen asleep on a date.",
//   "Never have I ever cried at a movie with my partner.",
//   "Never have I ever sent a risky text to the wrong person.",
//   "Never have I ever pretended to like something my partner loves.",
//   "Never have I ever secretly eaten my partner's food.",
//   "Never have I ever stayed up all night talking to someone I liked.",
//   "Never have I ever planned a surprise that completely backfired.",
//   "Never have I ever rewatched a show just because my partner wanted to.",
//   "Never have I ever said 'I love you' first.",
//   "Never have I ever been caught snooping through someone's phone.",
//   "Never have I ever faked being sick to stay home with my partner.",
//   "Never have I ever cried happy tears because of my partner.",
// ];

// export const TRIVIA = [
//   { q:"What year was Valentine's Day first associated with romantic love?",       a:"1375", hint:"Geoffrey Chaucer wrote a poem about it." },
//   { q:"Which country sends the most Valentine's Day cards?",                      a:"USA",  hint:"They send over a billion cards a year." },
//   { q:"What does the word 'love' literally mean in tennis?",                      a:"Zero", hint:"It comes from the French word for egg." },
//   { q:"Which Shakespeare play features the famous balcony love scene?",           a:"Romeo and Juliet", hint:"'What's in a name?'" },
//   { q:"In which city is the Taj Mahal, built as a symbol of love?",               a:"Agra", hint:"It's in India." },
//   { q:"What gemstone is traditionally given on a 45th wedding anniversary?",      a:"Sapphire", hint:"It's deep blue." },
//   { q:"Which hormone is known as the 'love hormone'?",                            a:"Oxytocin", hint:"Released during hugging." },
//   { q:"How many roses are typically in a dozen?",                                 a:"12",  hint:"One for each month of the year." },
//   { q:"What is the longest recorded marriage in history (in years, approx)?",     a:"86",  hint:"An American couple, married in 1924." },
//   { q:"In which country did the tradition of engagement rings originate?",        a:"Ancient Egypt", hint:"Circles symbolised eternity." },
// ];

// export const HOTTAKES = [
//   "Couples who don't argue are hiding something.",
//   "Planning date nights is more romantic than spontaneous ones.",
//   "Long distance relationships are actually stronger.",
//   "Sharing passwords is a sign of trust, not invasion.",
//   "It's okay to have separate friend groups completely.",
//   "Going to bed angry is sometimes healthier than forcing a resolution.",
//   "Couples should split all expenses 50/50, no exceptions.",
//   "Social media ruins relationships more than it helps them.",
//   "A couple that travels together stays together.",
//   "You should never stop flirting with your partner.",
//   "Taking breaks from each other makes the relationship stronger.",
//   "It is okay to keep some secrets from your partner.",
// ];
...
export const TABS = [
  ...
  {id:"memories",    label:"Memories",     emoji:"📸", imgs: timeline},
  {id:"games",       label:"Games",        emoji:"🎮", imgs: game},
  {id:"truthordare", label:"Truth or Dare",emoji:"💬", imgs: null},
  {id:"betgame",     label:"Bet Game",     emoji:"🎲", imgs: null},
  {id:"ideas",       label:"Ideas",        emoji:"💡", imgs: null},
  {id:"settings",    label:"Settings",     emoji:"⚙️", imgs: null},
];
